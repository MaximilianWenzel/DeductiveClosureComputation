...
/**
 * This class provides static methods in order to execute different closure computation benchmarks for the given, specified parameters.
 */
public class IndividualSaturationBenchmarks {
    ...
    private static final Set<Integer> binaryTreeDepthList;
    private static final Set<Integer> randomDigraphNodes;
    private static final Set<Integer> initialEchoAxioms;
    private static final Set<Integer> chainDepthList;
    private static final Set<Integer> numberOfWorkersList;
