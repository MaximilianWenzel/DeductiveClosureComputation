...
public final class NetworkCommunicationBenchmark_unpackedAxiomAndMetaInfoEncodedInInteger_jmhTest {
    ...
    public BenchmarkTaskResult unpackedAxiomAndMetaInfoEncodedInInteger_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_networkcommunicationbenchmark0_G.unpackedAxiomAndMetaInfoEncodedInInteger();
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            unpackedAxiomAndMetaInfoEncodedInInteger_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_networkcommunicationbenchmark0_G);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "unpackedAxiomAndMetaInfoEncodedInInteger", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
    ...
    public static void unpackedAxiomAndMetaInfoEncodedInInteger_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, NetworkCommunicationBenchmark_jmhType l_networkcommunicationbenchmark0_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult unpackedAxiomAndMetaInfoEncodedInInteger_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams    = threadParams;
        this.notifyControl   = control.notifyControl;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            unpackedAxiomAndMetaInfoEncodedInInteger_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_networkcommunicationbenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            res.measuredOps /= batchSize;
            BenchmarkTaskResult results = new BenchmarkTaskResult((long)res.allOps, (long)res.measuredOps);
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "unpackedAxiomAndMetaInfoEncodedInInteger", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public static void unpackedAxiomAndMetaInfoEncodedInInteger_avgt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, NetworkCommunicationBenchmark_jmhType l_networkcommunicationbenchmark0_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult unpackedAxiomAndMetaInfoEncodedInInteger_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams    = threadParams;
        this.notifyControl   = control.notifyControl;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            unpackedAxiomAndMetaInfoEncodedInInteger_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_networkcommunicationbenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            res.measuredOps *= opsPerInv;
            BenchmarkTaskResult results = new BenchmarkTaskResult((long)res.allOps, (long)res.measuredOps);
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "unpackedAxiomAndMetaInfoEncodedInInteger", buffer, benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public BenchmarkTaskResult unpackedAxiomAndMetaInfoEncodedInInteger_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        this.benchmarkParams = control.benchmarkParams;
        this.iterationParams = control.iterationParams;
        this.threadParams    = threadParams;
        this.notifyControl   = control.notifyControl;
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            unpackedAxiomAndMetaInfoEncodedInInteger_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_networkcommunicationbenchmark0_G);
            control.preTearDown();
            if (NetworkCommunicationBenchmark_jmhType.tearIterationMutexUpdater.compareAndSet(l_networkcommunicationbenchmark0_G, 0, 1)) {
                try {
                    if (control.isFailing) throw new FailureAssistException();
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "unpackedAxiomAndMetaInfoEncodedInInteger", res.getTime(), benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
